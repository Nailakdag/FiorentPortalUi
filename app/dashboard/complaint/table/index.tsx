...
export default function ComplaintTable({
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                size={"sm"}
                variant="ghost"
                className="inline-flex items-center px-4 py-2 hover:text-white bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors"
              >
                İşlemler
                <ChevronDownIcon
            ...
            <DropdownMenuContent align="start" className="w-auto z-[9999]">
              <DropdownMenuItem
                onClick={() => {
                  router.push(
                    `/dashboard/complaint/create-or-edit?id=${row.id}`,
                  );
                }}
              >
                Düzenle
  ...
  return (
    <DataTable
      ...
      showAddButton={true}
      addButtonText="Yeni Şikayet"
      onAddClick={() => router.push("/dashboard/complaint/create-or-edit")}
